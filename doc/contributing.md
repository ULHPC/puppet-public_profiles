...
# Public_profiles Puppet Module Developments
...
### Directory Layout
       ...
       ulhpc-public_profiles/       # Main directory 
           ...
           `-- manifests/
                ...
                `-- classes/     # Hold manifest for ulhpc-public_profiles classes/
                     `-- ulhpc-public_profiles.pp         # defines the ulhpc-public_profiles class
                     `-- ulhpc-public_profiles-params.pp  # ulhpc-public_profiles module variables 
                `-- definitions/ # Hold manifest for ulhpc-public_profiles definitions
                     `-- ulhpc-public_profiles-mydef.pp   # defines the ulhpc-public_profiles::mydef definition   `-- templates/        # Module ERB template files
